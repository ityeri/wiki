...
<새이름>으로 <기존이름>에 해당하는 홈의 이름을 변경합니다.

`/relocatehome <이름>`&#x20;

<이름>에 해당하는 홈의 위치를 현재 위치로 변경합니다.
...
또한 /global on|off로 전체채팅 표시를 전환할수 있습니다
...
인벤토리의 다이아몬드를 계좌에 입금합니다.

`/`출금

인벤토리의 다이아몬드를 계좌에서 출금합니다.
